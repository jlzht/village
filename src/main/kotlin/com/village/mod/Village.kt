...
import com.village.mod.village.structure.Campfire
...
object Village : ModInitializer {
    ...
    override fun onInitialize() {
        ...
        VillageInteractionCallback.EVENT.register({ player, pos, name ->
            ...
            val campfire = Campfire.createStructure(pos, player)
            if (campfire != null) {
                manager.addSettlement(name, pos, player)?.addStructure(campfire)
            }
        ...
        HandBellUsageCallback.EVENT.register({ player, pos ->
            ...
            settlements.filter { it.isLoaded && it.pos.getSquaredDistance(pos.toCenterPos()) < 16384.0f }.firstOrNull()?.let { settlement ->

...
sealed class Structure {
    ...
    fun isAvailable(): Boolean {
        LOGGER.info("Current:{}, Ocuppied:{} Max: {}", currentCapacity, capacity, maxCapacity)
        return capacity < currentCapacity && currentCapacity < maxCapacity
    }

    fun addResident(vid: Int) {
        LOGGER.info("ADD RESIDENT {}", vid)
    ...
    fun toNbt(): NbtCompound =
        NbtCompound().apply {
            ...
            putInt("StructureCapacity", capacity) // useless
